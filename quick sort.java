...
// Created Quicksort.java class
public class QuickSort {

  //Defining QuickSort() which takes two arguments and returns int value
...
// quicksort() with three arguments which returns int as value
